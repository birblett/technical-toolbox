...
/**
 * Re-introduces update skipping if config option is enabled; see {@link ConfigOption#LEGACY_TRAPDOOR_UPDATE_SKIPPING}
 */
...
public class RedstoneWireBlockMixin {
    ...
    private Block returnAirIfSkipping(Block b) {
        return ConfigOption.LEGACY_TRAPDOOR_UPDATE_SKIPPING.val() ? Blocks.AIR : b;
    }
